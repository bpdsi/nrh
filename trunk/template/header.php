		...
		<script type="text/javascript">
			$(function(){
				...
				$( "#StartDate" ).datepicker({
					...
					isBuddhist: true, 
					defaultDate: toDay,
					dayNames: ['เธญเธฒเธ—เธดเธ•เธขเน','เธเธฑเธเธ—เธฃเน','เธญเธฑเธเธเธฒเธฃ','เธเธธเธ','เธเธคเธซเธฑเธชเธเธ”เธต','เธจเธธเธเธฃเน','เน€เธชเธฒเธฃเน'],
		            dayNamesMin: ['เธญเธฒ.','เธ.','เธญ.','เธ.','เธเธค.','เธจ.','เธช.'],
		            monthNames: ['เธกเธเธฃเธฒเธเธก','เธเธธเธกเธ เธฒเธเธฑเธเธเน','เธกเธตเธเธฒเธเธก','เน€เธกเธฉเธฒเธขเธ','เธเธคเธฉเธ เธฒเธเธก','เธกเธดเธ–เธธเธเธฒเธขเธ','เธเธฃเธเธเธฒเธเธก','เธชเธดเธเธซเธฒเธเธก','เธเธฑเธเธขเธฒเธขเธ','เธ•เธธเธฅเธฒเธเธก','เธเธคเธจเธเธดเธเธฒเธขเธ','เธเธฑเธเธงเธฒเธเธก'],
		            monthNamesShort: ['เธก.เธ.','เธ.เธ.','เธกเธต.เธ.','เน€เธก.เธข.','เธ.เธ.','เธกเธด.เธข.','เธ.เธ.','เธช.เธ.','เธ.เธข.','เธ•.เธ.','เธ.เธข.','เธ.เธ.'],
				...
				<tr>
					<td class="home_menu">
						...
						<?php
							if($functionName=="Administrator"){
								if($permission=="admin"){
									$permissionName="เธเธนเนเธ”เธนเนเธฅเธฃเธฐเธเธเนเธฃเธเธเธขเธฒเธเธฒเธฅ";
								}else if($permission=="officer"){
									$permissionName="เน€เธเนเธฒเธซเธเนเธฒเธ—เธตเนเธฅเธเธ—เธฐเน€เธเธตเธขเธเธเธนเนเธเธญเนเธเนเธชเธดเธ—เธเธดเน";
								}else if($permission=="global"){
									$permissionName="เธเธนเนเธ”เธนเนเธฅเธฃเธฐเธเธ";
								}
								?><div>Welcome <?php echo $_SESSION["admin_Person"]["PersonName"]?> [<?php echo $permissionName?>] <input class="menu_logout" type="button" value="  เธญเธญเธเธเธฒเธเธฃเธฐเธเธ  "></div><?php
							}else{
								if($authen=="person"){
									?><div>Welcome <?php echo $_SESSION["sess_Person"]["PersonName"]?> <input class="menu_logout" type="button" value="  เธญเธญเธเธเธฒเธเธฃเธฐเธเธ  "></div><?php
								}else{
									?><div>Welcome <?php echo $_SESSION["sess_vc_Person"]["PersonName"]?> <input class="menu_logout" type="button" value="  เธญเธญเธเธเธฒเธเธฃเธฐเธเธ  "></div><?php
								}
							}
						?>
					</td>
