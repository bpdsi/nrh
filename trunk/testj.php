<html>
	...
	<body>
		...
		<form>
			<fieldset>
				<label>url:</label>
				<input type='text' id='url' value='http://nrh.dyndns.org/demo/refer_service.php' size='70' />
			</fieldset>
			<fieldset>
				<label>method:</label>
				<input type='text' id='method' value='QueryPatient' />
			</fieldset>
			<fieldset>
			...
			<fieldset>
				...
				<textarea id='params' rows='10' cols='50'><SOAP-ENV:Envelope SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/"><SOAP-ENV:Body><ns7030:QueryPatient xmlns:ns7030="http://tempuri.org"><PersonID xsi:type="xsd:string">1111111111111</PersonID><Hospital xsi:type="xsd:string"></Hospital><HospitalNumber xsi:type="xsd:string"></HospitalNumber></ns7030:QueryPatient></SOAP-ENV:Body></SOAP-ENV:Envelope></textarea>
			</fieldset>
			<fieldset>
				<label>namespace:</label>
				<input type='text' id='namespaceQualifier' value='xsd' class='no_width' size='5' />
				<input type='text' id='namespaceURL' value='http://nrh.dyndns.org/demo/refer_service.php' class='no_width' size='30' />
			</fieldset>
			<fieldset>
