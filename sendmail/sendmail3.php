...
<tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ด้วย โครงการบัณฑิตศึกษา ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัย-เกษตรศาสตร์  ได้กำหนดให้นิสิตปริญญาโท สาขาเทคโนโลยีสารสนเทศ(ภาคพิเศษ)   จัดงานสัมมนาเชิงวิชาการเป็นประจำทุกปี โดยได้รับความสนใจอย่างต่อเนื่องจากผู้เข้าร่วมการสัมมนาเป็นจำนวนมากมาโดยตลอด   สำหรับในปีนี้ นิสิตปริญญาโทฯ ได้กำหนดจัดงานสัมมนาวิชาการ BizIT 2009 หัวข้อเรื่อง Mission Possible: IT Strategies for Opportunity and Survival ขึ้น   ในระหว่างวันที่ 15 – 16 ตุลาคม 2552  ณ ห้องประชุมสุธรรม  อารีกุล  อาคารสารนิเทศ 50 ปี  มหาวิทยาลัยเกษตรศาสตร์  โดยมีวัตถุประสงค์เพื่อเผยแพร่ความรู้ในการนำเทคโนโลยีสารสนเทศมาใช้ให้เป็นรูปธรรม และก่อเกิดประโยชน์ต่อการดำเนินธุรกิจทุกระดับทั้งภาครัฐและเอกชน รวมทั้งเผยแพร่แนวคิด และมุมมองของการใช้เทคโนโลยีสารสนเทศเป็นเครื่องมือในการสร้างธุรกิจแนวใหม่  ซึ่งรายได้หลังหักค่าใช้จ่ายจะถูกนำไปซื้ออุปกรณ์ไอทีให้แก่โรงเรียนที่ขาดแคลน ตามรายละเอียดดังนี้
</td></tr>
<tr><td>
<br>
</td></tr>
...
$path = "C:\Schedule_BizIT2009.pdf";
$filename = $path;
#     2 megabytes = 2 097 152 bytes
if(filesize($filename) <  2097152){ // It's smaller than 2mb
echo $filename . ': ' . filesize($filename) . ' bytes';
} else {
echo "file to big.";
}
$name = "Schedule_BizIT2009.pdf";
$encoding = "base64";
...
$email=split(",","immwwi@hotmail.com, immwwi@gmail.com");
